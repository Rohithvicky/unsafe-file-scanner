...
class UnsafeFileScannerGUI:
    ...
    def setup_modern_layout(self):
        ...
        self.header_frame.pack(fill=tk.X, pady=(0, 20), padx=20)
        
        # Modern title layout with compact alignment
        self.title_label.pack(anchor=tk.W, pady=(15, 3))
        self.subtitle_label.pack(anchor=tk.W, pady=(0, 8))
        ...
        # Panel title - compact
        self.panel_title.pack(anchor=tk.W, pady=(15, 15), padx=20)
        
        # Modern directory selection layout - compact
        self.dir_frame.pack(fill=tk.X, pady=(0, 20), padx=20)
        ...
        self.output_frame.pack(fill=tk.X, pady=(0, 20), padx=20)
        ...
        self.control_frame.pack(fill=tk.X, pady=(0, 20), padx=20)
