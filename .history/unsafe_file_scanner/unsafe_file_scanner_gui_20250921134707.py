...
class UnsafeFileScannerGUI:
    ...
    def setup_modern_layout(self):
        ...
        # Advanced features buttons - exact scan config layout
        advanced_buttons_frame = tk.Frame(self.advanced_frame, bg='#161b22')
        advanced_buttons_frame.pack(fill=tk.X, pady=(0, 15))
        
        # Main advanced features button (prominent, full width)
        self.realtime_btn.pack(fill=tk.X, pady=(0, 10))
        
        # Secondary advanced features button (full width)
        self.rules_btn.pack(fill=tk.X, pady=(0, 10))
