...
class UnsafeFileScannerGUI:
    ...
    def create_modern_widgets(self):
        ...
        self.main_frame = tk.Frame(self.root, bg='#0d1117', padx=15, pady=15)
        ...
        # Modern browse button - compact size
        ...
        # Modern output browse button - compact size
        ...
        # Modern primary scan button - compact size
        ...
        # Modern secondary buttons - exact match to scan button
        ...
        # Modern real-time monitoring button - exact match to scan button
        self.realtime_btn = tk.Button(
            self.advanced_frame,
            text="👁️ Real-time Monitor",
            command=self.toggle_realtime_monitoring,
            state="normal" if REALTIME_AVAILABLE else "disabled",
            font=("SF Pro Text", 11, "bold"),
            bg='#da3633' if REALTIME_AVAILABLE else '#6c757d',
            fg='#ffffff',
            relief='flat',
            bd=0,
            padx=20,
        ...
        # Modern rules management button - exact match to scan button
        self.rules_btn = tk.Button(
            ...
            font=("SF Pro Text", 11, "bold"),
            bg='#6f42c1' if RULE_ENGINE_AVAILABLE else '#6c757d',
            fg='#ffffff',
            relief='flat',
            bd=0,
            padx=20,
        ...
        # Modern real-time control buttons - compact size
    ...
    def setup_modern_layout(self):
        ...
        # Modern title layout with compact alignment
        self.title_label.pack(anchor=tk.W, pady=(10, 3))
        self.subtitle_label.pack(anchor=tk.W, pady=(0, 6))
        self.status_indicator.pack(anchor=tk.W, pady=(0, 15))
        
        # Modern content area with side-by-side layout - compact
        self.content_frame.pack(fill=tk.BOTH, expand=True, pady=(0, 10))
        
        # Modern left panel with card-like appearance - compact
        self.left_panel.pack(side=tk.LEFT, fill=tk.BOTH, expand=True, padx=(0, 8))
        
        # Panel title - compact
        self.panel_title.pack(anchor=tk.W, pady=(10, 10), padx=15)
        
        # Modern directory selection layout - compact
        self.dir_frame.pack(fill=tk.X, pady=(0, 15), padx=15)
        
        self.dir_label.pack(anchor=tk.W, pady=(0, 8))
        self.dir_entry.pack(side=tk.LEFT, fill=tk.X, expand=True, padx=(0, 8))
        self.dir_browse_btn.pack(side=tk.RIGHT)
        
        # Modern output file layout - compact
        self.output_frame.pack(fill=tk.X, pady=(0, 15), padx=15)
        
        self.output_label.pack(anchor=tk.W, pady=(0, 8))
        self.output_file_entry.pack(side=tk.LEFT, fill=tk.X, expand=True, padx=(0, 8))
        self.output_file_browse_btn.pack(side=tk.RIGHT)
        
        # Modern control buttons layout - compact
        self.control_frame.pack(fill=tk.X, pady=(0, 15), padx=15)
        
        # Main scan button (prominent) - compact
        self.scan_btn.pack(fill=tk.X, pady=(0, 8))
        
        # Secondary buttons in a row - compact
        button_row = tk.Frame(self.control_frame, bg='#161b22')
        button_row.pack(fill=tk.X, pady=(0, 6))
        
        self.stop_btn.pack(side=tk.LEFT, fill=tk.X, expand=True, padx=(0, 4))
        self.clear_btn.pack(side=tk.RIGHT, fill=tk.X, expand=True, padx=(4, 0))
        
        
        # Modern advanced features layout - compact
        self.advanced_frame.pack(fill=tk.X, pady=(0, 15), padx=15) 
        
        # Advanced features title with separator - compact
        self.advanced_title.pack(anchor=tk.W, pady=(0, 6))
        
        # Visual separator line
        separator_line = tk.Frame(self.advanced_frame, height=1, bg='#30363d')
        separator_line.pack(fill=tk.X, pady=(0, 8))
        
        # Advanced features buttons - compact layout
        advanced_buttons_frame = tk.Frame(self.advanced_frame, bg='#161b22')
        advanced_buttons_frame.pack(fill=tk.X, pady=(0, 8))
        
        # Main advanced features button (prominent, full width) - compact
        self.realtime_btn.pack(fill=tk.X, pady=(0, 6))
        
        # Secondary advanced features button (full width) - compact
        self.rules_btn.pack(fill=tk.X, pady=(0, 6))
        
        # Modern real-time monitoring controls - compact
        self.realtime_controls_frame.pack(fill=tk.X, pady=(0, 8))
        
        # Real-time controls title with separator - compact
        self.realtime_controls_title.pack(anchor=tk.W, pady=(0, 4))
        
        # Visual separator line for real-time controls
        realtime_separator = tk.Frame(self.realtime_controls_frame, height=1, bg='#30363d')
        realtime_separator.pack(fill=tk.X, pady=(0, 6))
        
        # Real-time controls - compact layout
        realtime_controls_grid = tk.Frame(self.realtime_controls_frame, bg='#161b22')
        realtime_controls_grid.pack(fill=tk.X, pady=(6, 0))
        
        # Real-time control buttons in a compact row
        realtime_button_row = tk.Frame(realtime_controls_grid, bg='#161b22')
        realtime_button_row.pack(fill=tk.X, pady=(0, 4))
        
        # Arrange buttons with proper spacing in the button row frame
        self.view_realtime_btn.pack(in_=realtime_button_row, side=tk.LEFT, padx=(0, 6))
        self.export_realtime_btn.pack(in_=realtime_button_row, side=tk.LEFT, padx=(0, 6))
        self.clear_realtime_btn.pack(in_=realtime_button_row, side=tk.LEFT)
        
        # Modern export format layout - compact
        self.export_format_frame.pack(fill=tk.X, pady=(0, 8))
        
        # Export format title - compact
        self.export_format_title.pack(anchor=tk.W, pady=(0, 4))
        
        # Export format menu
        self.export_format_menu.pack(anchor=tk.W)
        
        # Export button for advanced features
        self.advanced_export_btn = tk.Button(
            self.export_format_frame,
            text="💾 Export Results",
        ...
        self.advanced_export_btn.pack(anchor=tk.W, pady=(8, 0))
        
        # Modern right panel - Results
        self.right_panel.pack(side=tk.RIGHT, fill=tk.BOTH, expand=True)
        
        # Results panel title - compact
        self.results_title.pack(anchor=tk.W, pady=(10, 10), padx=15)
        
        # Modern results summary - compact
        self.summary_frame.pack(fill=tk.X, pady=(0, 8), padx=15)
        self.summary_label.pack(anchor=tk.W)
        
        # Modern security metrics - compact
        self.metrics_frame.pack(fill=tk.X, pady=(0, 8), padx=15)
        
        # Metrics in a row
        metrics_row = tk.Frame(self.metrics_frame, bg='#161b22')
        metrics_row.pack(fill=tk.X)
        
        self.files_scanned_label.pack(side=tk.LEFT, padx=(0, 15))
        self.unsafe_files_label.pack(side=tk.LEFT, padx=(0, 15))
        self.scan_time_label.pack(side=tk.RIGHT)
        
        # Modern progress bar
        self.progress_bar.pack(fill=tk.X, pady=(0, 10), padx=15)
    ...
    def apply_modern_theme(self):
        ...
        # Advanced features hover effects - exact scan config match
        add_hover_effect(self.realtime_btn, '#f85149', '#da3633')
        add_hover_effect(self.rules_btn, '#8b5cf6', '#6f42c1')
        add_hover_effect(self.view_realtime_btn, '#f85149', '#da3633')
        add_hover_effect(self.export_realtime_btn, '#8b5cf6', '#6f42c1')
        add_hover_effect(self.clear_realtime_btn, '#8b5cf6', '#6f42c1')
        add_hover_effect(self.advanced_export_btn, '#388bfd', '#1f6feb')
