...
class UnsafeFileScannerGUI:
    ...
    def create_widgets(self):
        ...
        # Left panel - Controls with professional styling
        ...
        # Directory selection - Professional single directory selection
        self.dir_frame = ttk.Frame(self.left_panel)
        self.dir_label = ttk.Label(self.dir_frame, text="Target Directory:", font=("Segoe UI", 10, "bold"))
        self.dir_entry = ttk.Entry(self.dir_frame, width=50, font=("Segoe UI", 9))
        ...
        # Output file with professional styling
        ...
        self.output_file_entry = ttk.Entry(self.output_frame, width=50, font=("Segoe UI", 9))
        ...
        # Main control buttons with improved styling
        ...
        # Advanced features with professional styling
    ...
    def setup_layout(self):
        ...
        # Directory selection - Professional single line layout
        self.dir_frame.grid(row=0, column=0, sticky=(tk.W, tk.E), pady=(0, 15))
        self.dir_frame.columnconfigure(1, weight=1)
        
        self.dir_label.grid(row=0, column=0, columnspan=2, sticky=tk.W, pady=(0, 10))
        self.dir_entry.grid(row=1, column=0, sticky=(tk.W, tk.E), padx=(0, 10))
        self.dir_browse_btn.grid(row=1, column=1)
        ...
        self.scan_btn.grid(row=0, column=0, columnspan=2, sticky=(tk.W, tk.E), pady=(0, 10))
        
        # Secondary buttons in a row
        self.stop_btn.grid(row=1, column=0, padx=(0, 5), sticky=(tk.W, tk.E), pady=(0, 5))
        self.clear_btn.grid(row=1, column=1, padx=(5, 0), sticky=(tk.W, tk.E), pady=(0, 5))
        
        # Export button (full width)
        self.export_btn.grid(row=2, column=0, columnspan=2, sticky=(tk.W, tk.E), pady=(5, 0))
        
        # Advanced features
        self.advanced_frame.grid(row=3, column=0, sticky=(tk.W, tk.E), pady=(0, 15))
