...
class UnsafeFileScannerGUI:
    ...
    def create_modern_widgets(self):
        ...
        # Modern secondary buttons - matching scan button style
        ...
        # Modern real-time monitoring button - exact scan button style
        ...
        # Modern rules management button - exact scan button style
        ...
        # Modern real-time control buttons - matching scan button style
    ...
    def setup_modern_layout(self):
        ...
        self.rules_btn.pack(fill=tk.X, pady=(0, 15))
