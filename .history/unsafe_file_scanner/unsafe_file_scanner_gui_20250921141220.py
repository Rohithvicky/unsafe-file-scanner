...
class UnsafeFileScannerGUI:
    ...
    def apply_modern_theme(self):
        ...
        add_hover_effect(self.realtime_btn, '#da3633', '#f85149')
        add_hover_effect(self.rules_btn, '#6f42c1', '#8b5cf6')
        add_hover_effect(self.view_realtime_btn, '#da3633', '#f85149')
        add_hover_effect(self.export_realtime_btn, '#6f42c1', '#8b5cf6')
        add_hover_effect(self.clear_realtime_btn, '#6f42c1', '#8b5cf6')
