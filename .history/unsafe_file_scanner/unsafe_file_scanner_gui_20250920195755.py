...
class UnsafeFileScannerGUI:
    ...
    def setup_modern_layout(self):
        ...
        # Advanced features title
        self.advanced_title.pack(anchor=tk.W, pady=(0, 15))
        ...
        self.realtime_btn.pack(side=tk.LEFT, fill=tk.X, expand=True, padx=(0, 8))
        self.rules_btn.pack(side=tk.RIGHT, fill=tk.X, expand=True, padx=(8, 0))
