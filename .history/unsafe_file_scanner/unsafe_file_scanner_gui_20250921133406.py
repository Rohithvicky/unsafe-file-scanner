...
class UnsafeFileScannerGUI:
    ...
    def create_modern_widgets(self):
        ...
        # Modern real-time control buttons - matching scan config style
    ...
    def apply_modern_theme(self):
        ...
        # Advanced features hover effects - matching scan config
        add_hover_effect(self.realtime_btn, '#f85149', '#da3633')
        add_hover_effect(self.rules_btn, '#8b5cf6', '#6f42c1')
        add_hover_effect(self.view_realtime_btn, '#1f6feb', '#388bfd')
        add_hover_effect(self.export_realtime_btn, '#1f6feb', '#388bfd')
