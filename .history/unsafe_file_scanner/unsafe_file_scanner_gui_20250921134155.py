...
class UnsafeFileScannerGUI:
    ...
    def create_modern_widgets(self):
        ...
        # Modern browse button - matching scan button style
        ...
        # Modern output browse button - matching scan button style
        ...
        # Modern real-time control buttons - smaller size, exact scan config style
