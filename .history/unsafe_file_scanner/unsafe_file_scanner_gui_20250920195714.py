...
class UnsafeFileScannerGUI:
    ...
    def create_modern_widgets(self):
        ...
        # Modern real-time monitoring button
        ...
        # Modern rules management button
        ...
        # Modern real-time control buttons
    ...
    def setup_modern_layout(self):
        ...
        # Modern advanced features buttons
        ...
        # Real-time controls in a row
        realtime_controls_row = tk.Frame(self.realtime_controls_frame, bg='#161b22')
        realtime_controls_row.pack(fill=tk.X)
