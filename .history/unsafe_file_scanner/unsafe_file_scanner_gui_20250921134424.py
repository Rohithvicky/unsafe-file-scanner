...
class UnsafeFileScannerGUI:
    ...
    def setup_modern_layout(self):
        ...
        self.view_realtime_btn.pack(in_=realtime_button_row, side=tk.LEFT, padx=(0, 10))
        self.export_realtime_btn.pack(in_=realtime_button_row, side=tk.LEFT, padx=(0, 10))
