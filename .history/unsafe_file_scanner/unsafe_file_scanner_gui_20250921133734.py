...
class UnsafeFileScannerGUI:
    ...
    def setup_modern_layout(self):
        ...
        # Real-time controls - exact scan config layout
        realtime_controls_grid = tk.Frame(self.realtime_controls_frame, bg='#161b22')
        realtime_controls_grid.pack(fill=tk.X, pady=(10, 0))
        
        # Real-time control buttons in a row - exact scan config style
        realtime_button_row = tk.Frame(realtime_controls_grid, bg='#161b22')
        realtime_button_row.pack(fill=tk.X, pady=(0, 10))
        
        self.view_realtime_btn.pack(side=tk.LEFT, fill=tk.X, expand=True, padx=(0, 5))
        self.export_realtime_btn.pack(side=tk.LEFT, fill=tk.X, expand=True, padx=(0, 5))
        self.clear_realtime_btn.pack(side=tk.RIGHT, fill=tk.X, expand=True)
