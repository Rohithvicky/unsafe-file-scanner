...
class UnsafeFileScannerGUI:
    ...
    def setup_modern_layout(self):
        ...
        self.results_title.pack(anchor=tk.W, pady=(15, 15), padx=20)
        
        # Modern results summary - compact
        self.summary_frame.pack(fill=tk.X, pady=(0, 12), padx=20)
        self.summary_label.pack(anchor=tk.W)
        
        # Modern security metrics - compact
        self.metrics_frame.pack(fill=tk.X, pady=(0, 12), padx=20)
