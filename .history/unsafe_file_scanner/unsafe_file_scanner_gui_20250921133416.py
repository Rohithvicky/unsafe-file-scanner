...
class UnsafeFileScannerGUI:
    ...
    def setup_modern_layout(self):
        ...
        # Advanced features buttons - matching scan config layout
        advanced_buttons_frame = tk.Frame(self.advanced_frame, bg='#161b22')
        advanced_buttons_frame.pack(fill=tk.X, pady=(0, 15))
        
        # Main advanced features buttons in a row
        self.realtime_btn.pack(side=tk.LEFT, fill=tk.X, expand=True, padx=(0, 5))
        self.rules_btn.pack(side=tk.RIGHT, fill=tk.X, expand=True, padx=(5, 0))
