...
class UnsafeFileScannerGUI:
    ...
    def setup_layout(self):
        ...
        # Control buttons
        self.control_frame.grid(row=2, column=0, columnspan=2, sticky=(tk.W, tk.E), pady=(0, 10))
        ...
        self.scan_btn.grid(row=0, column=0, padx=(0, 10), sticky=(tk.W, tk.E))
        ...
        self.quick_scan_btn.grid(row=0, column=0, padx=(0, 10), sticky=(tk.W, tk.E))
        self.demo_btn.grid(row=0, column=1)
