...
class UnsafeFileScannerGUI:
    ...
    def create_widgets(self):
        ...
        # Status indicators
        self.status_indicators_frame = ttk.Frame(self.progress_frame)
        self.files_scanned_label = ttk.Label(self.status_indicators_frame, text="Files scanned: 0")
        self.unsafe_files_label = ttk.Label(self.status_indicators_frame, text="Unsafe files: 0")
        self.scan_time_label = ttk.Label(self.status_indicators_frame, text="Scan time: 0.00s")
