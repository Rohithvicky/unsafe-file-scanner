...
class UnsafeFileScannerGUI:
    ...
    def create_widgets(self):
        ...
        self.dir_entry = ttk.Entry(self.dir_frame, width=50, font=("Consolas", 9))
        ...
        # Directory listbox
        self.dir_listbox = tk.Listbox(self.dir_frame, height=6, selectmode=tk.MULTIPLE, font=("Consolas", 9))
        ...
        self.output_file_entry = ttk.Entry(self.output_frame, width=50, font=("Consolas", 9))
        ...
        self.log_level_label = ttk.Label(self.options_frame, text="Log Level:", font=("Segoe UI", 9))
    ...
    def setup_layout(self):
        ...
        # Configuration frame
        self.config_frame.grid(row=2, column=0, columnspan=2, sticky=(tk.W, tk.E), pady=(0, 10))
        ...
        main_controls = ttk.Frame(self.control_frame)
        main_controls.grid(row=0, column=0, sticky=(tk.W, tk.E), pady=(0, 10))
        main_controls.columnconfigure(0, weight=1)
        main_controls.columnconfigure(1, weight=1)
        main_controls.columnconfigure(2, weight=1)
        main_controls.columnconfigure(3, weight=1)
        ...
        quick_controls = ttk.Frame(self.control_frame)
        quick_controls.grid(row=1, column=0, sticky=(tk.W, tk.E))
        quick_controls.columnconfigure(0, weight=1)
        quick_controls.columnconfigure(1, weight=1)
        
        self.quick_scan_btn.grid(row=0, column=0, padx=(0, 5), sticky=(tk.W, tk.E))
        self.demo_btn.grid(row=0, column=1, sticky=(tk.W, tk.E))
        
        # Progress
        self.progress_frame.grid(row=4, column=0, columnspan=2, sticky=(tk.W, tk.E), pady=(0, 10))
        ...
        # Status indicators
        self.status_indicators_frame.grid(row=2, column=0, columnspan=2, sticky=(tk.W, tk.E))
        ...
        # Results frame
        self.results_frame.grid(row=5, column=0, columnspan=2, sticky=(tk.W, tk.E, tk.N, tk.S), pady=(0, 10))
        ...
        # Status bar
        self.status_bar_frame.grid(row=6, column=0, columnspan=2, sticky=(tk.W, tk.E))
    ...
    def start_scan(self):
        ...
        self.progress_label.config(text="🔍 Performing security scan...", foreground="#3498db")
        self.status_label.config(text="Scanning...")
        
        # Reset status indicators
        self.files_scanned_label.config(text="Files scanned: 0")
        self.unsafe_files_label.config(text="Unsafe files: 0")
        self.scan_time_label.config(text="Scan time: 0.00s")
    ...
    def scan_completed(self):
        ...
        self.progress_label.config(text="✅ Security scan completed successfully", foreground="#27ae60")
        ...
        if self.scanner:
            ...
            self.files_scanned_label.config(text=f"Files scanned: {stats['total_files']}")
            self.unsafe_files_label.config(text=f"Unsafe files: {stats['unsafe_files']}")
            self.scan_time_label.config(text=f"Scan time: {stats['scan_duration']:.2f}s")
